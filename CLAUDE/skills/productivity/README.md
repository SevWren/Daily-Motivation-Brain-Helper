...
- **[self-reflect](./self-reflect/SKILL.md)** — Enterprise-grade forensic self-reflection: 8-phase audit with pass/fail gates, mandate compliance matrix, platform drift forensics, test quality review, root cause taxonomy, and ranked generation constraints.
