...
- **[self-reflect](./self-reflect/SKILL.md)** — LLM self-reflection over recent git history: extract evidence, audit CLAUDE.md mandate compliance, identify Windows/Linux drift, and produce ranked generation rules for next work.
